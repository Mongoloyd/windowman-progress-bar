...
const ScamConcernImage = () => {
  ...
  return (
    <section
      ref={ref}
      className="w-full py-8 md:py-12 px-4 flex justify-center bg-background">
      ...
      <motion.figure
        ...
        <figcaption className="mt-3 text-center">
          <button
            ...
            className="text-sm text-cyan hover:text-cyan-light transition-colors cursor-pointer font-extrabold md:text-xl"
