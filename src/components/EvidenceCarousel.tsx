        ...
        <div className="flex">
          {slides.map((slide, i) => (
            ...
            >
              ...
              {/* Gradient overlay at z-10 */}
              <div
                className="absolute inset-x-0 bottom-0 h-1/3 bg-gradient-to-t from-black/60 to-transparent rounded-b-xl pointer-events-none"
                style={{ zIndex: 10 }}
              />

              {/* Caption at z-20 */}
              <p
                className="absolute bottom-3 left-3 right-3 text-white relative"
                style={{
                  zIndex: 20,
        ...
        {slides.map((_, i) => (
          <button
            ...
            style={{
              ...
              height: 8,
              backgroundColor: selectedIndex === i ? "#0099BB" : "#D1D5DB",
              border: "none",
              cursor: "pointer",
            }}
          />
