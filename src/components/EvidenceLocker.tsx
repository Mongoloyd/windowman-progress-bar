...
const EvidenceLocker = ({
  ...
  return (
    <div style={{ background: "white" }} className="py-16 md:py-20 px-4 md:px-8">
      ...
      <motion.div {...stagger(1)} className="max-w-3xl mx-auto" style={{ border: "2px solid #E5E7EB", borderRadius: 20, boxShadow: "0 8px 40px rgba(15,31,53,0.10)", overflow: "hidden", background: "white" }}>
        ...
        <div style={{ padding: "28px 24px" }}>
          ...
          <VaultRow
            ...
            right={
              <div style={{ width: 36, height: 36, borderRadius: "50%", background: config.bg, border: `2px solid ${config.color}`, display: "flex", alignItems: "center", justifyContent: "center" }}>
                <span style={{ fontFamily: "'DM Mono', monospace", fontSize: 16, fontWeight: 900, color: config.color }}>{grade}</span>
              </div>
            }
          />
          {/* Row 2 — Red Flags */}
          ...
          <VaultRow
            ...
            right={
              <span style={{ background: "#FDF3E3", border: "1px solid #C8952A", borderRadius: 999, padding: "3px 10px", fontFamily: "'DM Sans', sans-serif", fontSize: 11, fontWeight: 600, color: "#C8952A" }}>
                Ready to use
              </span>
            }
          />
          ...
          <VaultRow
            ...
            right={
              <span style={{ background: "#ECFDF5", border: "1px solid #059669", borderRadius: 999, padding: "3px 10px", fontFamily: "'DM Sans', sans-serif", fontSize: 11, fontWeight: 600, color: "#059669" }}>
                3 available
              </span>
            }
          />
      ...
      {/* SECTION 3 — FUTURE SELF SCENARIO */}
      <div className="max-w-4xl mx-auto mt-12 grid grid-cols-1 md:grid-cols-2 gap-6">
        <motion.div {...stagger(2)} style={{ background: "#FEF2F2", border: "1.5px solid #FECACA", borderRadius: 14, padding: "28px 24px" }}>
          ...
          <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 14, color: "#374151", lineHeight: 1.8, marginTop: 10 }}>
            No window brand specified. No warranty negotiation. ${dollarDelta.toLocaleString()} above fair market.
            The contractor gets a signature before 5pm.
            You get windows that may or may not be what you expected.
          </p>
          <p style={{ fontFamily: "'DM Mono', monospace", fontSize: 13, fontWeight: 700, color: "#DC2626", marginTop: 16 }}>
        ...
        <motion.div {...stagger(3)} style={{ background: "#ECFDF5", border: "1.5px solid #A7F3D0", borderRadius: 14, padding: "28px 24px" }}>
          ...
          <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 14, color: "#374151", lineHeight: 1.8, marginTop: 10 }}>
            You ask for the brand in writing. You push for 3-year warranty.
            You have a counter-quote from a vetted contractor ready if they don't move.
            The contractor knows you know.
          </p>
          <p style={{ fontFamily: "'DM Mono', monospace", fontSize: 13, fontWeight: 700, color: "#059669", marginTop: 16 }}>
