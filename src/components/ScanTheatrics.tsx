...
const ScanTheatrics = ({ isActive, selectedCounty = "your", onRevealComplete }: ScanTheatricsProps) => {
  ...
  const startScanning = () => {
    ...
    // At 8s: cliffhanger
    addTimer(() => {
      setActiveLogIndex(6); // last item active
      setPhase("cliffhanger");
    }, 8000);

    // After 2s cliffhanger → OTP
