      ...
      <div ref={ref} className="mx-auto max-w-5xl px-4 md:px-8 py-20 md:py-28">
            ...
            >
              ...
              <div className="flex justify-between items-start">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 16, fontWeight: 700, color: "#0F1F35" }}>
                      {story.name}
                    </p>
                  ...
                  >
                    <span
                      style={{
                        ...
                        fontSize: 20,
                        fontWeight: 700,
                        color: story.gradeColor,
                      }}
                    >
                      {story.grade}
                    </span>
                  </div>
                  <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 10, color: "#9CA3AF", marginTop: 4 }}>
                    Before scan
                  </p>
                </div>
              </div>
              ...
              <div
                ...
                style={{ background: "#ECFDF5", borderRadius: 10, padding: "16px 20px", marginTop: 20 }}
              >
                <span style={{ color: "#059669", fontSize: 20 }}>✓</span>
                <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 14, color: "#065F46", fontWeight: 600 }}>
                  {story.result}
                </p>
              </div>
        ...
        <div className="hidden md:flex flex-col items-center mt-8 gap-2">
          <div className="flex gap-2">
            <span
              style={{ width: 8, height: 8, borderRadius: "50%", backgroundColor: "#0F1F35", display: "inline-block" }}
            />
            <span
              style={{ width: 8, height: 8, borderRadius: "50%", backgroundColor: "#D1D5DB", display: "inline-block" }}
            />
          </div>
