...
const questions = [
  {
    ...
    labelColor: "hsl(0 72% 51%)",
    circleBg: "hsl(0 93% 97%)",
    circleBorder: "hsl(0 72% 51%)",
  ...
  },
  {
    ...
    labelColor: "hsl(40 96% 40%)",
    circleBg: "hsl(48 96% 95%)",
    circleBorder: "hsl(45 93% 47%)",
    ...
    askLabel: "SAY EXACTLY THIS:",
    askColor: "hsl(40 96% 40%)",
    askBorder: "hsl(45 93% 47%)",
  ...
  },
  {
    ...
    labelColor: "hsl(192 100% 37%)",
    circleBg: "hsl(192 76% 94%)",
    circleBorder: "hsl(192 100% 37%)",
    ...
    askLabel: "SAY EXACTLY THIS:",
    askColor: "hsl(192 100% 37%)",
    askBorder: "hsl(192 100% 37%)",
        ...
        <div className="relative overflow-hidden" style={{ background: "hsl(0 0% 100%)", border: "1.5px solid hsl(220 13% 91%)", borderRadius: 16, boxShadow: "0 4px 24px hsla(213 57% 14% / 0.10)" }}>
          ...
          <div className="relative z-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3" style={{ background: "hsl(213 57% 14%)", padding: "18px 28px" }}>
            ...
            <div className="shrink-0">
              <p style={{ fontFamily: "'DM Mono', monospace", fontSize: 13, color: "hsl(36 77% 47%)", fontWeight: 700, letterSpacing: "0.15em" }}>WINDOWMAN.PRO</p>
              <p style={{ fontFamily: "'DM Mono', monospace", fontSize: 10, color: "hsl(220 9% 46%)" }}>Forensic Intelligence Division</p>
            </div>
            {/* Center */}
            <div className="text-left sm:text-center flex-1">
              <p style={{ fontFamily: "'DM Mono', monospace", fontSize: 12, color: "hsl(0 0% 100%)", fontWeight: 700 }}>HOMEOWNER'S FORENSIC CHECKLIST</p>
              <p style={{ fontFamily: "'DM Mono', monospace", fontSize: 10, color: "hsl(220 9% 46%)" }}>Pre-Quote Site Visit Edition</p>
            </div>
            {/* Right */}
            <div className="shrink-0">
              <div style={{ background: "hsla(0 72% 51% / 0.15)", border: "1px solid hsla(0 72% 51% / 0.3)", borderRadius: 6, padding: "5px 10px" }}>
                <p style={{ fontFamily: "'DM Mono', monospace", fontSize: 10, color: "hsl(0 72% 51%)", fontWeight: 700, letterSpacing: "0.08em" }}>CONFIDENTIAL</p>
              </div>
              <p style={{ fontFamily: "'DM Mono', monospace", fontSize: 9, color: "hsl(220 9% 46%)", marginTop: 2 }}>For homeowner use only</p>
            </div>
          </div>
          ...
          <div className="relative z-10 flex gap-4 items-start" style={{ padding: "28px 28px 20px", borderBottom: "1px solid hsl(220 13% 91%)" }}>
            {/* Clipboard icon */}
            <div className="shrink-0 hidden sm:flex items-center justify-center" style={{ width: 48, height: 48, borderRadius: 10, background: "hsl(192 76% 94%)" }}>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="hsl(192 100% 37%)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div>
              <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 20, fontWeight: 700, color: "hsl(213 57% 14%)" }}>
                5 Questions Contractors Hope You Never Ask
              </p>
              <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 14, color: "hsl(220 9% 30%)", lineHeight: 1.75, marginTop: 6 }}>
              ...
              <p style={{ fontFamily: "'DM Mono', monospace", fontSize: 11, color: "hsl(0 72% 51%)", fontWeight: 600, marginTop: 10 }}>
              ...
              <div key={q.id} style={{ padding: "24px 0", borderBottom: "1px solid hsl(210 20% 97%)" }}>
                ...
                <div className="flex items-start justify-between gap-3">
                  <div className="flex items-start gap-3 flex-1">
                    ...
                    <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 16, fontWeight: 700, color: "hsl(213 57% 14%)", lineHeight: 1.4, paddingTop: 4 }}>
                      {q.question}
                    </p>
                  </div>
                  {/* Checkbox */}
                  <button
                    ...
                    style={{
                      ...
                      height: 24,
                      borderRadius: 4,
                      border: `2px solid ${checked[q.id] ? "hsl(160 84% 39%)" : "hsl(220 13% 83%)"}`,
                      background: checked[q.id] ? "hsl(160 84% 39%)" : "hsl(0 0% 100%)",
                      cursor: "pointer",
                      display: "flex",
                      alignItems: "center",
                ...
                <div style={{ marginTop: 12, background: "hsl(210 20% 98%)", borderRadius: 8, padding: "14px 16px" }}>
                  <p style={{ fontFamily: "'DM Mono', monospace", fontSize: 10, letterSpacing: "0.1em", color: q.labelColor, marginBottom: 8 }}>
                    {q.label}
                  </p>
                  <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 13, color: "hsl(220 9% 30%)", lineHeight: 1.7 }}>
                    {q.why}
                  </p>
                </div>
                ...
                <div style={{ marginTop: 12, background: "hsl(0 0% 100%)", borderLeft: `3px solid ${q.askBorder}`, borderRadius: 4, padding: "10px 14px" }}>
                  <p style={{ fontFamily: "'DM Mono', monospace", fontSize: 10, color: q.askColor, letterSpacing: "0.08em", marginBottom: 4 }}>
                    {q.askLabel}
                  </p>
                  <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 14, color: "hsl(213 57% 14%)", fontStyle: "italic", fontWeight: 500, lineHeight: 1.6 }}>
                    {q.askText}
                  </p>
                </div>
              </div>
          ...
          <div className="relative z-10" style={{ padding: "24px 28px", borderTop: "1px solid hsl(220 13% 91%)", background: "hsl(210 20% 98%)" }}>
            ...
            <div className="flex items-center gap-3 mb-3">
              <p style={{ fontFamily: "'DM Mono', monospace", fontSize: 12, color: "hsl(220 9% 46%)" }}>
                {checkedCount} of 5 reviewed
              </p>
              <div className="flex-1" style={{ height: 4, background: "hsl(220 13% 91%)", borderRadius: 2, overflow: "hidden" }}>
                <motion.div
                  style={{ height: "100%", background: "hsl(160 84% 39%)", borderRadius: 2 }}
            ...
            {/* State messages */}
            {checkedCount === 0 && (
              <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 14, color: "hsl(220 9% 46%)", fontStyle: "italic" }}>
                Check each question as you confirm it with your contractor.
              </p>
            )}
            {checkedCount > 0 && checkedCount < 5 && (
              <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 14, color: "hsl(220 9% 30%)" }}>
                {checkedCount} items reviewed. {5 - checkedCount} remaining before signing is safe.
              </p>
            )}
            {checkedCount === 5 && (
              <>
                <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 14, fontWeight: 600, color: "hsl(160 84% 39%)" }}>
        ...
        <div className="text-center" style={{ background: "hsl(0 0% 100%)", padding: "40px 28px", borderRadius: 16, marginTop: 32 }}>
          ...
          <motion.button
            ...
            style={{
              ...
              borderRadius: 10,
              border: "none",
              boxShadow: "0 4px 14px hsla(36 77% 47% / 0.35)",
              cursor: "pointer",
            }}
          >
