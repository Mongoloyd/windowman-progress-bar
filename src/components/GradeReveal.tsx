        ...
        <div className="max-w-4xl mx-auto flex flex-col items-center text-center">
          <motion.div
            ...
            style={{
              ...
              boxShadow: `0 0 0 12px ${config.color}1A, 0 0 48px ${config.color}33`,
            }}
          ...
          <motion.div {...stagger(2.5)} style={{ background: config.bg, border: `1.5px solid ${config.color}`, borderRadius: 999, padding: "6px 20px", marginTop: 20 }}>
            <span style={{ fontFamily: "'DM Mono', monospace", fontSize: 12, fontWeight: 700, color: config.color, letterSpacing: "0.1em" }}>
              GRADE {grade} — {config.label}
            </span>
          </motion.div>

          <motion.p {...stagger(3.3)} style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "clamp(17px, 2vw, 19px)", color: "#374151", marginTop: 12 }}>
            {config.message}
          </motion.p>
        </div>
      </section>

      {/* SECTION 2 — PRICE ANALYSIS BAND */}
      <section style={{ background: "white", borderTop: "1px solid #E5E7EB", borderBottom: "1px solid #E5E7EB" }} className="py-12 md:py-16 px-4 md:px-8">
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <motion.div {...stagger(3.5)}>
            ...
            <p style={{ fontFamily: "'DM Mono', monospace", fontSize: 24, fontWeight: 700, color: "#0099BB" }}>
              ${fairPriceLow.toLocaleString()} – ${fairPriceHigh.toLocaleString()}
            </p>
        ...
        <div className="max-w-4xl mx-auto">
            ...
            {flags.map((flag, i) => {
              ...
              return (
                <motion.div
                  ...
                  style={{ background: "white", border: s.border, borderLeft: s.borderLeft, borderRadius: 10, padding: "20px 20px 20px 24px" }}
                >
                  <span style={{ display: "inline-block", background: s.badgeBg, borderRadius: 999, padding: "3px 10px", fontFamily: "'DM Mono', monospace", fontSize: 10, fontWeight: 700, color: s.badgeColor, letterSpacing: "0.06em" }}>
                    {s.badgeText}
                  </span>
          ...
          <div style={{ background: "#0F1F35", borderRadius: 10, padding: "16px 20px", marginTop: 20 }} className="flex flex-col md:flex-row md:items-center md:justify-between gap-2">
            <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 14, color: "white" }}>
              {redCount} critical issue{redCount !== 1 ? "s" : ""}, {amberCount} caution{amberCount !== 1 ? "s" : ""}, {greenCount} item{greenCount !== 1 ? "s" : ""} correct.
            </p>
      ...
      <section style={{ background: "#FAFAFA", borderTop: "1px solid #E5E7EB" }} className="py-12 md:py-16 px-4 md:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 15, color: "#6B7280", marginBottom: 32 }}>
            Your analysis is saved. You can come back to it anytime.
          </p>
          ...
          <div className="flex flex-col md:flex-row justify-center gap-4">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              onClick={() => {
                console.log({ event: "wm_report_downloaded" });
                toast({ title: "Report saved to your downloads" });
              }}
          ...
          <button
            onClick={() => {
              console.log({ event: "wm_report_shared" });
          ...
          <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 13, color: "#9CA3AF", marginTop: 20 }}>
            Your contractor will never see this report unless you choose to share it.
          </p>
        </div>
      </section>
    </motion.div>
